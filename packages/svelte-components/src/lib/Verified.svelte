<script lang="ts">
    import { giphyBlack, giphyWhite } from '@giphy/js-brand'

    export let fill = giphyWhite
    export let size = 12
</script>

<svg height="{size}px" width="19px" viewBox="0 0 19 17">
    <path
