...
describe('gif util', () => {
    test('getBestRenditionUrl ', () => {
        ...
        expect(getBestRenditionUrl(testGifLandscape, 400, 300)).toEqual('/media/355x200.gif')
        expect(getBestRenditionUrl(testGifLandscape, 300, 300)).toEqual('/media/355x200.gif')
        expect(getBestRenditionUrl(testGifLandscape, 200, 200)).toEqual('/media/200x113.gif')
    ...
    test('getBestRenditionUrl portrait target landscape gif ', () => {
        ...
        expect(getBestRenditionUrl(testGifLandscape, 300, 400)).toEqual('/media/355x200.gif')
        ...
        expect(getBestRenditionUrl(testGifLandscape, 50, 100)).toEqual('/media/178x100.gif')
        expect(getBestRenditionUrl(testGifLandscape, 1, 1)).toEqual('/media/100x56.gif')
        expect(getBestRenditionUrl(testGifLandscape, 0, 1)).toEqual('')
    })
    test('getBestRenditionUrl landscape target portrait gif ', () => {
        ...
        expect(getBestRenditionUrl(testGifPortrait, 100, 50)).toEqual('/media/100x178.gif')
