...
const SearchIcon = ({ className = '', size = 25 }: Props) => (
    <svg width={size} height={size} viewBox="0 0 30 30" version="1.1" className={className}>
        <defs>
            <path
        ...
        <g id="search" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="icons/search">
                ...
                <use id="Mask" fill="#FFFFFF" fillRule="nonzero" xlinkHref="#path-1"></use>
                <g mask="url(#mask-2)">
