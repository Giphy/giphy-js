...
const VerifiedBadge = ({ className = '', size = 14, fill = '#15CDFF' }: Props) => (
    <svg
        className={cx(VerifiedBadge.className, className)}
        height={size}
        version="1.1"
        viewBox="-1 0 18 18"
        width={size}
    >
        <g fill={fill} transform="translate(-324.000000, -132.000000)">
